...
{#if debug}
	...
	>
		<!-- * Sun * -->
		<svg class="fill-yellow-600 dark:hidden" width="24" height="24" viewBox="0 0 16 16">
			<path
		...
		<!-- * Moon * -->
		<svg class="hidden fill-gray-100 dark:block" width="24" height="24" viewBox="0 0 16 16">
			<path
